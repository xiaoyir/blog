...
2.去OpenResty官网下载最新版本的OpenRestry：http://openresty.org/cn/download.html，本次下载的是openresty-1.21.4.1-win64.zip，然后解压。
...
![img_5.png](../../img/nginx/01/img_5.png)
4.访问页面验证，成功返回。

![img_6.png](../../img/nginx/01/img_6.png)
![img_7.png](../../img/nginx/01/img_7.png)
...
![img_8.png](../../img/nginx/01/img_8.png)
...
![img.png](../../img/nginx/01/configParam.png)
